...
Class Ekasoft_basicws extends CModule
{
	...
	function InstallFiles($arParams = array())
	{
        ...
        CopyDirFiles($_SERVER['DOCUMENT_ROOT'].'/bitrix/modules/'.$this->MODULE_ID.'/install/wizards/'.$this->PARTNER_NAME.'/basicws', $_SERVER['DOCUMENT_ROOT'].'/bitrix/wizards/'.$this->PARTNER_NAME.'/basicws', true, true);
		return true;
	}
	...
	function UnInstallFiles()
	{
        ...
        DeleteDirFilesEx('/bitrix/wizards/eka-soft/basicws');
        return true;
	}
