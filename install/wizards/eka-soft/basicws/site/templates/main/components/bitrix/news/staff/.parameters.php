...
$arTemplateParameters = array(
    ...
    "DETAIL_IMG_WIDTH" => Array(
        "NAME" => "width of the image in the detail",
        "TYPE" => "STRING",
        "VALUE" => "",
        "DEFAULT" =>220,
    ),
    "DETAIL_IMG_HEIGHT" => Array(
        "NAME" => "height of the image in the detail",
        "TYPE" => "STRING",
        "VALUE" => "",
        "DEFAULT" =>220,
    ),
    ...
    "TEXT_READ_MORE" => Array(
        "NAME" => "text to read more",
        "TYPE" => "STRING",
        "VALUE" => "",
        "DEFAULT" =>"Подробнее"
    ),
